                        ...
                        <div class="card-body">
                            <form id="form" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-inline">
                                        <div class="form-check mr-3">
                                            ...
                                            <label class="form-check-label" for="option1">Thanh toán khi nhận hàng</label>
                                        </div>

                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="guest_pay" id="option2" value="Chuyển khoản">
                                            <label class="form-check-label" for="option2">Chuyển khoản</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php if ($result_total->num_rows > 0 AND $result_date->num_rows > 0) { ?>
                                    <button name="sbm" class="btn btn-success" type="submit">Thanh toán</button>
                                <?php } ?>
                                <span id="error"></span>
                            </form>
                        </div>
